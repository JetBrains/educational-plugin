...
project("AI") {
  ...
  tasks.test {
    useJUnit {
      excludeCategories("com.jetbrains.edu.hints.validation.AiAutoQualityCodeTests")
    }
  }
  ...
  tasks.register<Test>("categorySpecificTest") {
    ...
    useJUnit {
      includeCategories("com.jetbrains.edu.hints.validation.AiAutoQualityCodeTests")
    }
  }
}
