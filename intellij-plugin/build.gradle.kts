...
dependencies {
  intellijPlatform {
    ...
    pluginModule(implementation(project("features:ai-debugger-kotlin")))
    pluginModule(implementation(project("features:ai-validation")))
  ...
  intellijPlatformTesting {
    ...
    runIde.register("buildEventsScheme") {
      task {
        ...
        // BACKCOMPAT: 2024.3. Update value to 251 and this comment
        // `IDEA_BUILD_NUMBER` variable is used by `buildEventsScheme` task to write `buildNumber` to output json.
        // It will be used by TeamCity automation to set minimal IDE version for new events
        environment("IDEA_BUILD_NUMBER", "243")
      }
    }
