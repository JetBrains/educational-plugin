...
data class AITranslationFeedbackInfoData(
  ...
  override fun toString(): String =
    buildString {
      ...
      appendLine(EduAIBundle.message("ai.translation.share.feedback.dialog.info.data.task.id"))
      appendLine(taskId)
      appendLine(EduAIBundle.message("ai.translation.share.feedback.dialog.info.data.task.name"))
      appendLine(taskName)
