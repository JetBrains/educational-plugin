...
class ScalaGradleVersionValidationTest(
  ...
  override val environment: String get() = "Gradle"
  ...
  companion object {
    ...
    fun data(): Collection<Array<Any?>> {
      ...
      return listOf(
        ...
        // iterate through all language versions, but the validation result must not depend on it for Scala
