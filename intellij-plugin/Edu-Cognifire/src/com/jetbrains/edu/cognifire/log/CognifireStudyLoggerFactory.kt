...
class CognifireStudyLoggerFactory(private val category: String): Logger.Factory {
  private val basePath: Path = Path.of(PathManager.getPluginsPath()) / "cognifire-study" / "cognifire-study.log"
