...
abstract class PyCheckersTestBase : CheckersTestBase<PyLanguageEnvironment>() {
  override fun createCheckerFixture(): EduCheckerFixture<PyLanguageEnvironment> = PyCheckerFixture()
}
