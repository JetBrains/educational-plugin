...
class PyCheckiOCheckListener : CheckiOCheckListener(
  CheckiOCourseContentGenerator(PythonFileType.INSTANCE, PyCheckiOApiConnector),
  PyCheckiOOAuthConnector
) {
  override fun isEnabledForCourse(course: CheckiOCourse): Boolean = PythonLanguage.INSTANCE == course.languageById
}
