 ...
 */
class GoCheckerFixture : EduCheckerFixture<GoLanguageEnvironment>() {
  ...
  override val projectSettings: GoLanguageEnvironment get() = GoLanguageEnvironment.Existing(GoSdk.fromHomePath(sdkLocation))
