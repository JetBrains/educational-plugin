...
interface FunctionDiffReducer<T : PsiElement> {
   ...
   *
   * @param currentFunction The original function from student's code. Can be null if the hint suggests
   *                adding a completely new function that doesn't exist in student's code yet.
   * @param codeHintFunction The suggested version of the function from the generated hint.
