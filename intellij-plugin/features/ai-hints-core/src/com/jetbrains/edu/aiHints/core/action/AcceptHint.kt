...
class AcceptHint : ApplyCodeAction() {
  ...
  override fun createCustomComponent(presentation: Presentation, place: String): JComponent = JButton(presentation.text).apply {
    ...
    isFocusable = true
    addActionListener {
      val event = AnActionEvent.createEvent(ActionToolbar.getDataContextFor(this), null, place, ActionUiKind.NONE, null)
      ActionUtil.performAction(this@AcceptHint, event)
    }
  }
