...
class PromotionCheckListenerTest : EduTestCase() {
  ...
  override fun setUp() {
    ...
    every { mockedStudentPackPromotionStep.performStep(any(), any()) } returns GotItBalloonStepData(
      GotItComponentBuilder(""),
      RelativePoint(Point(0, 0)),
      RelativePoint(Point(0, 0)),
      null,
      ZhabaComponent(this.project)
    )
