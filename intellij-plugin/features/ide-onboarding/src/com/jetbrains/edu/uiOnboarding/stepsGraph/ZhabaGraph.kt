...
class ZhabaMainGraph private constructor(
  ...
  init {
    val initialOnboardingStep: ZhabaStepBase = ZhabaStepFactory.noOpStep(STEP_ID_START_ONBOARDING_JUMP_OUT, NEXT_TRANSITION, StartOnboardingZhabaData)
    ...
    val initialStudentPackPromotionStep: ZhabaStepBase = ZhabaStepFactory.noOpStep(STEP_ID_PROMOTE_STUDENT_PACK_JUMP_OUT, NEXT_TRANSITION, StartStudentPackPromotionZhabaData)
  ...
  companion object {
    ...
    const val STEP_ID_START_ONBOARDING_JUMP_OUT: String = ".start.onboarding"
    const val STEP_ID_START_ONBOARDING: String = WelcomeStep.STEP_KEY

    const val STEP_ID_PROMOTE_STUDENT_PACK_JUMP_OUT: String = ".start.student.pack"
    const val STEP_ID_PROMOTE_STUDENT_PACK: String = StudentPackPromotionStep.STEP_ID
