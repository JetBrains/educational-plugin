...
internal class CheckSolutionStep : EduUiOnboardingStep {
    override suspend fun performStep(project: Project, disposable: CheckedDisposable): EduUiOnboardingStepData? {
        ...
        // Position the balloon above the check button
    ...
    // Helper function to find the left actions toolbar in the check panel
    private fun findLeftActionsToolbar(checkPanel: CheckPanel): java.awt.Component? {
        // The check panel has a BorderLayout with the check actions panel in the CENTER
        if (checkPanel !is java.awt.Container) return null
        ...
        // The left actions toolbar is in the WEST position of the check actions panel
    ...
    // Helper function to find a component with BorderLayout
...
// Extension function to find a component of a specific type in the component hierarchy
...
// Extension function to find a component by name in the component hierarchy
