...
class NodesTest : CourseViewTestBase() {
  ...
  fun `test visible and invisible additional files colouring for educator`() {
    fun CourseBuilder.visibleInvisible(path: String? = null) {
    ...
    courseWithFiles(courseMode = CourseMode.EDUCATOR) {
      ...
      visibleInvisible()
      visibleInvisible("dir")
      visibleInvisible("section1")
      visibleInvisible("section1/dir")
      visibleInvisible("section1/lesson1")
      visibleInvisible("section1/lesson1/dir")
    }
