...
abstract class FrameworkLessonsUpdateTest<T : Course> : UpdateTestBase<T>() {
  ...
  fun `test update invisible binary file`() {
    ...
    assertTaskFolder {
      ...
      file("InvisibleBinaryFile.png", task1.taskFiles["InvisibleBinaryFile.png"]!!.contents)
      file("Tests1.kt", "fun test1() {}")
    }
    ...
    assertTaskFolder {
      file("Task.kt", "fun task() {}")
      file("VisibleBinaryFile.png")
      file("InvisibleBinaryFile.png", task2.taskFiles["InvisibleBinaryFile.png"]!!.contents)
      file("Tests2.kt", "fun test2() {}")
    }
    ...
    assertTaskFolder {
      file("Task.kt", "fun task() {}")
      file("VisibleBinaryFile.png")
      file("InvisibleBinaryFile.png", task3.taskFiles["InvisibleBinaryFile.png"]!!.contents)
      file("Tests3.kt", "fun test3() {}")
    }
  }
