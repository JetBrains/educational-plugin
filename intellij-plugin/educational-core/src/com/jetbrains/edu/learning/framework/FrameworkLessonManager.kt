...
interface FrameworkLessonManager : EduTestAware {
  ...
  fun saveExternalChanges(task: Task, externalState: Map<String, FileContents>)
  fun updateUserChanges(task: Task, newInitialState: Map<String, FileContents>)
   ...
   */
  fun getTaskState(lesson: FrameworkLesson, task: Task): Map<String, FileContents>
