...
private class NewTaskToolbarAction : CCCreateTask(EducationalCoreIcons.CourseCreator.NewTask) {
  ...
  override fun actionPerformed(e: AnActionEvent) {
    ...
    val newEvent = createNewEvent(e, newLessonPlace, EduFormatNames.TASK) ?: return
...
private class NewLessonToolbarAction : CCCreateLesson(EducationalCoreIcons.CourseCreator.NewLesson) {
  override fun actionPerformed(e: AnActionEvent) {
    ...
    val newEvent = createNewEvent(e, newLessonPlace, EduFormatNames.LESSON) ?: return
    super.actionPerformed(newEvent)
  }
...
private fun createNewEvent(e: AnActionEvent, newItemPlace: NewItemPlace, newItemPrefix: String): AnActionEvent? {
