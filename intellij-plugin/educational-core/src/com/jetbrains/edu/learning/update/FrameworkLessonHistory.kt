...
import com.jetbrains.edu.learning.framework.impl.textContentEquals
  ...
  companion object {
    ...
    fun create(
      ...
      val localHistory = evaluateHistory(localLesson, fileName, propagateFilesOnNavigation) { index, task, unmodifiedContents ->
        ...
        if (actualContents?.textContentEquals(unmodifiedContents) == true) { null } else { actualContents }
      }
