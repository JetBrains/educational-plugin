...
import com.jetbrains.edu.learning.marketplace.settings.checkboxes.MarketplaceCheckBox
import com.jetbrains.edu.learning.marketplace.settings.checkboxes.SolutionSharingCheckBox
import com.jetbrains.edu.learning.marketplace.settings.checkboxes.StatisticsCollectionCheckBox
import com.jetbrains.edu.learning.marketplace.settings.checkboxes.UserAgreementCheckBox
...
class MarketplaceOptions : OAuthLoginOptions<MarketplaceAccount>() {
  ...
  private val userAgreementCheckBox = UserAgreementCheckBox().apply {
    addItemListener { e ->
  ...
  private val shareMySolutionsCheckBox = SolutionSharingCheckBox()

  private val statisticsCollectionAllowedCheckBox = StatisticsCollectionCheckBox()
  ...
  override fun postLoginActions() {
    ...
    getAdditionalComponents().forEach { checkBox ->
      (checkBox as MarketplaceCheckBox).update()
    }
  }
