...
object MarketplaceOpenInIdeRequestHandler : OpenInIdeRequestHandler<BaseMarketplaceOpenCourseRequest>() {
  ...
  override fun openInExistingProject(
    request: BaseMarketplaceOpenCourseRequest,
  ...
  override fun getCourse(request: BaseMarketplaceOpenCourseRequest, indicator: ProgressIndicator): Result<Course, CourseValidationResult> {
  ...
  override fun afterProjectOpened(request: BaseMarketplaceOpenCourseRequest, project: Project) {
