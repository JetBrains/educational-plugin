...
abstract class BaseMarketplaceOpenCourseRequest(val courseId: Int, val studyItemId: Int) : OpenInIdeRequest {
 ...
 */
class MarketplaceOpenCourseRequest(courseId: Int, studyItemId: Int) : BaseMarketplaceOpenCourseRequest(courseId, studyItemId)