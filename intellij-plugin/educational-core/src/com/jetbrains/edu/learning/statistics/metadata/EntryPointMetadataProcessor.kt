...
import com.jetbrains.edu.learning.statistics.metadata.CourseMetadataManager.Companion.ENTRY_POINT
...
class EntryPointMetadataProcessor : CourseMetadataProcessor<String> {
  ...
  override fun processMetadata(project: Project, course: Course, metadata: String) {
    CourseMetadataManager.getInstance(project).addMetadata(ENTRY_POINT to metadata)
  }
}
