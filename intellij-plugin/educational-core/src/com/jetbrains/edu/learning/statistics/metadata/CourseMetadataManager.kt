...
import com.jetbrains.edu.learning.statistics.metadata.CourseMetadataManager.MetadataState
...
@State(name = "CourseMetadataManager", storages = [Storage(StoragePathMacros.WORKSPACE_FILE, roamingType = RoamingType.DISABLED)])
class CourseMetadataManager(
  ...
  companion object {
    ...
    fun getInstance(project: Project): CourseMetadataManager = project.service()
  }
