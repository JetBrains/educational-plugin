...
private class RemoveFileFromArchive(private val course: Course, private val path: String) : State {
  ...
  private val initialIndex: Int = course.additionalFiles.indexOfFirst { it.name == path }
  private val initialFile: EduFile = course.additionalFiles[initialIndex]
  ...
  override fun restoreState(project: Project) {
    ...
    course.additionalFiles = course
      .additionalFiles
      .take(initialIndex) + initialFile + course
        .additionalFiles
        .drop(initialIndex + 1)
  }
}
