...
class IntroduceWhenSubjectInspectionProcessing(private val project: Project, private val element: PsiElement) :
  ...
  override fun isApplicable(): Boolean = runReadAction {
    ...
    if (element !is KtWhenExpression) return@runReadAction false
