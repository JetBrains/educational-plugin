...
class LiftReturnOrAssignmentInspectionProcessing(private val project: Project, private val element: PsiElement) : InspectionProcessing {
  ...
  override fun isApplicable(): Boolean = runReadAction {
    ...
    val state = LiftReturnOrAssignmentInspection.Util.getState(element as KtExpression, skipLongExpressions = false) ?: return@runReadAction false
