...
class JoinDeclarationAndAssignmentInspectionProcessing(private val project: Project, private val element: PsiElement) :
  ...
  override fun isApplicable(): Boolean = runReadAction {
    ...
    if (element !is KtProperty) return@runReadAction false
