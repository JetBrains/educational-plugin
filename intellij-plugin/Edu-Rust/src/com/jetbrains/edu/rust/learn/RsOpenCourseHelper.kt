...
import com.jetbrains.edu.learning.statistics.metadata.CourseMetadataManager
  ...
  private fun Course.createProject(toolchain: RsToolchainBase, projectLocation: Path?) {
    ...
    try {
      ...
      val project = projectGenerator?.doCreateCourseProject(
        ...
        openCourseParams = mapOf(CourseMetadataManager.ENTRY_POINT to RUST_ROVER_BANNER)
      )
      if (project != null) {
