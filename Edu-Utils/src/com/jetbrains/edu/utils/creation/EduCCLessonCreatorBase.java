package com.jetbrains.edu.utils.creation;
...
public class EduCCLessonCreatorBase implements CCLessonCreator {

  @Override
  public PsiDirectory createLesson(@NotNull Project project, @NotNull StudyItem item, @Nullable IdeView view, @NotNull PsiDirectory parentDirectory, @NotNull Course course) {
