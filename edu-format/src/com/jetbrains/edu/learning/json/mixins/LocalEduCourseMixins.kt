...
import com.jetbrains.edu.learning.json.mixins.JsonMixinNames.CONTENT_SHIFT
...
@JsonPropertyOrder(
  ...
  COURSE_TYPE, SOLUTIONS_HIDDEN, PLUGINS, ITEMS, AUTHORS, TAGS, ADDITIONAL_FILES, CONTENT_SHIFT, VERSION
)
abstract class LocalEduCourseMixin {
  ...
  @JsonProperty(CONTENT_SHIFT)
  @JsonInclude(JsonInclude.Include.NON_EMPTY)
  lateinit var contentShift: String
