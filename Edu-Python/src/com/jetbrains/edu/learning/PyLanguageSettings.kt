...
internal abstract class PyLanguageSettings : EduPluginConfigurator.LanguageSettings<PyNewProjectSettings> {
  ...
  protected abstract fun getAllSdks(project: Project): List<Sdk>
  protected abstract fun getInterpreterComboBox(project: Project, registeredSdks: List<Sdk>, fakeSdk: Sdk?): ComboboxWithBrowseButton
