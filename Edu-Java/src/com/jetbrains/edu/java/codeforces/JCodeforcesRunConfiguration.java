...
public class JCodeforcesRunConfiguration extends ApplicationConfiguration implements CodeforcesRunConfiguration {
  private static final Logger LOG = Logger.getInstance(JCodeforcesRunConfiguration.class);

  public JCodeforcesRunConfiguration(@NotNull Project project, @NotNull ConfigurationFactory factory) {
