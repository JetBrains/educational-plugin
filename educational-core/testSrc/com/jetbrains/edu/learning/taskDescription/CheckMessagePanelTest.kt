...
import com.jetbrains.edu.learning.taskDescription.ui.check.CheckMessagePanel.Companion.prepareHtmlText
...
class CheckMessagePanelTest {
  ...
  fun `test message`() {
    ...
    val expected = """<html><head></head><body>Failed. Perhaps, you changed something in the code. Just copy it!</body></html>"""
  ...
  fun `test message wrapped with html tag`() {
    ...
    val expected = """<html><head></head><body><html>Passed. Congratulations! It is your first Kotlin program that really works. In future topics, you will learn more about this code.</html></body></html>"""
    doTest(input, expected)
  }
