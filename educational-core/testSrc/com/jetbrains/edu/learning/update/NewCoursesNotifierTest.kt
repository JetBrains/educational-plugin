...
class NewCoursesNotifierTest : EduTestCase() {
  ...
  private fun doTest(expectedCheckNumber: Int, expectedCourses: List<StepikCourse>, courseProducer: (Int) -> List<StepikCourse>) {
    ...
    try {
      val newCourses = Collections.synchronizedList(mutableListOf<StepikCourse>())
  ...
  private class TestCoursesProvider(private val producer: (Int) -> List<StepikCourse>) : CoursesProvider {
