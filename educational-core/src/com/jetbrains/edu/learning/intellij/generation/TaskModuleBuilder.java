...
public class TaskModuleBuilder extends EduBaseIntellijModuleBuilder {
  private final Task myTask;
  private final Module myUtilModule;

  public TaskModuleBuilder(String moduleDir, @NotNull String name, @NotNull Task task, @NotNull Module utilModule) {
    myTask = task;
