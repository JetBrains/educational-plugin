...
/**
 * Viewer initialization is made in [com.jetbrains.edu.learning.taskDescription.ui.tab.AdditionalTab.setupTextViewer] method,
 * and it must be called in constructor to initialize all necessary UI.
 */
abstract class AdditionalTab(val project: Project, private val tabType: TabType) : JPanel(BorderLayout()), Disposable {
