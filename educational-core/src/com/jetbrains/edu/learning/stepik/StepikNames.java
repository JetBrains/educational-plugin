...
public class StepikNames {
  ...
  public static final String CLIENT_ID = StepikOAuthBundle.INSTANCE.valueOrDefault("stepikClientId", "");
  public static final String CLIENT_SECRET = StepikOAuthBundle.INSTANCE.valueOrDefault("stepikClientSecret", "");
