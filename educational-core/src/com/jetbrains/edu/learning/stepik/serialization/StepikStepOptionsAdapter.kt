...
class StepikStepOptionsAdapter(val language: String?) : JsonDeserializer<StepOptions> {

  @Throws(JsonParseException::class)
  override fun deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext): StepOptions {
    val stepOptionsJson = migrate(json.asJsonObject, JSON_FORMAT_VERSION, language)
    return GsonBuilder().setFieldNamingPolicy(FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES).create()
      .fromJson(stepOptionsJson, StepOptions::class.java)
  }
