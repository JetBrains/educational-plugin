...
class GradleTaskChecker(task: EduTask, project: Project) : TaskChecker<EduTask>(task, project) {
    override fun check(): CheckResult {
        ...
        return try {
            ...
            Logger.getInstance(GradleTaskChecker::class.java).info(CheckUtils.FAILED_TO_CHECK_MESSAGE, e)
            FAILED_TO_CHECK
        }
    }
