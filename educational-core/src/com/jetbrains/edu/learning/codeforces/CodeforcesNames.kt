...
object CodeforcesNames {
  ...
  private const val CONTESTS_POST = "$CODEFORCES_URL/blog/entry/456"
  private const val CONTESTS_RULES = "$CODEFORCES_URL/blog/entry/4088"
  private const val THIRD_PARTY_CODE_RULE_CHANGING = "$CODEFORCES_URL/blog/entry/8790"
  val PRETTY_TERMS_OF_AGREEMENT = EduCoreBundle.message("codeforces.default.terms.of.agreement", CONTESTS_POST, CONTESTS_RULES,
                                                        THIRD_PARTY_CODE_RULE_CHANGING)
