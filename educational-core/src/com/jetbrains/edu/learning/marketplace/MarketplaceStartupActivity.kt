...
class MarketplaceStartupActivity : StartupActivity {
  ...
  override fun runActivity(project: Project) {
    ...
    marketplaceConnector.setSubmissionTabListener(object : EduLogInListener {
      ...
      override fun userLoggedOut() {
        // TODO: strange situation: when one logged out from 'Marketplace' he can actually be logged out
        // only from hub, maybe disable logout at all
        if (project.isDisposed || marketplaceConnector.isLoggedIn()) return
