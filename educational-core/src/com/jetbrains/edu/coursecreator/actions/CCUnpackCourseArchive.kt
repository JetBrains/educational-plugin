...
class CCUnpackCourseArchive : DumbAwareAction("Unpack Course From Archive") {
  ...
  private fun initializeCourseProject(courseProject: Project, course: Course) {
  ...
  companion object {
    private val LOG = Logger.getInstance(CCUnpackCourseArchive::class.java)
  }
}
